        ...
        <form action="{{ route('cv') }}" method="post" class="form-group text-dark" enctype="multipart/form-data">
            ...
            <div class="personal">
                ...
                <div class="mb-2 form-floating">
                    <textarea class="form-control" placeholder="Permanent Address" id="permanent_adddress"
                        style="height: 100px" title="Permanent Address" name="permanent_adddress" required></textarea>
            ...
            <div class="mb-4 education">
                ...
                <div class="ssc">
                    ...
                    <div class="mb-2 form-floating">
                        <input type="text" class="form-control" name="ssc_year" id="ssc_year"
                            aria-describedby="Passing Year" placeholder="Passing Year" title="Passing Year" required>
                    ...
                    <div class="mb-2 form-floating">
                        <input type="text" class="form-control" name="ssc_board" id="ssc_board" aria-describedby="Board"
                            placeholder="Board" title="Board" required>
                ...
                <div class="hsc">
                    ...
                    <div class="mb-2 form-floating">
                        <input type="text" class="form-control" name="hsc_board" id="hsc_board" aria-describedby="Board"
                            placeholder="Board" title="Board">
                ...
                <div class="bsc">
                    ...
                    <div class="mb-2 form-floating">
                        <input type="text" class="form-control" name="bsc_board" id="bsc_board" aria-describedby="Board"
                            placeholder="Board" title="Board">
                ...
                <div class="msc">
                    ...
                    <div class="mb-2 form-floating">
                        <input type="text" class="form-control" name="msc_board" id="msc_board" aria-describedby="Board"
                            placeholder="Board" title="Board">
            ...
            <div class="experience">
                <div class="mb-2 form-floating">
                    <textarea class="form-control" placeholder="Experience" id="experience" name="experience"
                        style="height: 100px" title="Experience"></textarea>
            ...
            <div class="references">
                <div class="mb-2 form-floating">
                    <textarea class="form-control" placeholder="References" id="references" name="references"
                        style="height: 100px" title="References"></textarea>
